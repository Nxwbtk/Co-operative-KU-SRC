...
import { INavigationOptions } from ".";
...
export function DataTablePagination<TData>(
  ...
  const { table, selectable = false, navigationOptions = {} } = props;
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between px-2 space-y-4 sm:space-y-0">
      ...
      <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 lg:space-x-8">
        <div className="flex items-center space-x-2">
          <p className="text-sm font-medium">จำนวนรายการต่อหน้า</p>
          <Select
