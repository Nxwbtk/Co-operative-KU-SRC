...
export type TEditAwardDialogProps = {
  editData: TGetAward;
};

export const EditAwardDialog = (props: TEditAwardDialogProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px] w-[95vw] max-w-[95vw] sm:w-full">
        <DialogHeader>
          <DialogTitle className="text-lg sm:text-xl font-semibold">แก้ไขรางวัล</DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form
